...
Q.8.1 A logical knowledge base represents the world using a set of sentences
...
Q.8.2 Consider a knowledge base containing just two sentences: $P(a)$ and
$P(b)$. Does this knowledge base entail $\forall\,x\ P(x)$? Explain your
answer in terms of models.

Q.8.3 Is the sentence ${\exists\,x,y\;\;} x{{\,=\,}}y$ valid? Explain.

Q.8.4 Write down a logical sentence such that every world in which it is true
contains exactly one object.

Q.8.5 Write down a logical sentence such that every world in which it is true
contains exactly two objects.

Q.8.6 \[fol-model-count-exercise\] Consider a symbol vocabulary that contains
...
Q.8.7 Which of the following are valid (necessarily true) sentences?
...
Q.8.8 \[empty-universe-exercise\] Consider a version of the semantics for
...
Q.8.9 \[hillary-exercise\]Does the fact
