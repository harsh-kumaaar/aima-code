...
Q.5.1 Suppose you have an oracle, $OM(s)$, that correctly predicts the
...
Q.5.2 Consider the problem of solving two 8-puzzles.
...
Q.5.3 Imagine that, in Exercise \[two-friends-exercise\], one of
...
Q.5.4 \[game-playing-chance-exercise\]Describe and implement state
...
Q.5.5 Describe and implement a *real-time*,
...
Q.5.6 Discuss how well the standard approach to game playing would apply to
games such as tennis, pool, and croquet, which take place in a
continuous physical state space.

Q.5.7 \[minimax-optimality-exercise\] Prove the following assertion: For every
...
Q.5.8 Consider the two-player game described in
...
Q.5.9 This problem exercises the basic concepts of game playing, using
