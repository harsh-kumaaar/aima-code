...
Q.3.2 Give a complete problem formulation for each of the following problems.
...
Q.3.3 Your goal is to navigate a robot out of a maze. The robot starts in the
...
Q.3.4 You have a $9 \times 9$ grid of squares, each of which can be colored
...
Q.3.5 \[two-friends-exercise\]Suppose two friends live in different cities on
...
Q.3.6 \[8puzzle-parity-exercise\] Show that the 8-puzzle states are divided
...
Q.3.7 \[nqueens-size-exercise\] Consider the $n$-queens problem using the
...
Q.3.8 Give a complete problem formulation for each of the following. Choose a
...
Q.3.9 \[path-planning-exercise\]Consider the problem of finding the shortest
