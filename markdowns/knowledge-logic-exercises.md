...
Q.7.1 Suppose the agent has progressed to the point shown in
...
Q.7.2 (Adapted from @Barwise+Etchemendy:1993 .) Given the following, can you prove that the unicorn is
...
Q.7.3 \[truth-value-exercise\] Consider the problem of deciding whether a
...
Q.7.4 Which of the following are correct?
...
Q.7.5 Which of the following are correct?
...
Q.7.6 \[deduction-theorem-exercise\] Prove each of the following assertions:
...
Q.7.7 Prove, or find a counterexample to, each of the following assertions:
...
Q.7.8 Prove, or find a counterexample to, each of the following assertions:
...
Q.7.9 Consider a vocabulary with only four propositions, $A$, $B$, $C$, and
